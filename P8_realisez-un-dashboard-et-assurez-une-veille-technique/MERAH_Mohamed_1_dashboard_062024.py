...
#Feature importance / description
    if st.checkbox("**INFORMATION COMPLÉMENTAIRES ?**",key="Option3"):
        ...
        """ 1) Le score est en dessous de 50% → la demande de prêt est refusée.  \n """
        """ 2) Le score est entre 50 et 53% → la demande de prêt est acceptée 
        ...
        """3) Le score est au dessus de 53% → la demande de prêt est acceptée. """) 
    else:
        st.markdown("<i>…</i>", unsafe_allow_html=True)  
